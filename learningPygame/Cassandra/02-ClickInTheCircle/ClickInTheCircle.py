...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            #  2: doneFor a MOUSEBUTTONDOWN event get the click position.
            ...
            # done4: Set the message_text to either 'Bullseye!' or 'You missed!'
