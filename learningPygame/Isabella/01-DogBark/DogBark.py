...
def main():
    ...
    while True:
        ...
        caption = caption_font.render("I do the talking", True, WHITE)
        caption2 = caption_font.render("Jus stay quiet and nod", True, WHITE)
        # TODO 6: Draw (blit) the text image onto the screen in the middle bottom.
        screen.blit(caption, ((IMAGE_SIZE - caption.get_width())//2, IMAGE_SIZE-80))
        screen.blit(caption2, ((IMAGE_SIZE - caption2.get_width()) // 2, IMAGE_SIZE - 40))
