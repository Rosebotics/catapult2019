...
class Missile:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)), (self.x, self.y), (self.x, self.y - 8), 4)
...
def main():
    ...
    while True:
        ...
        for badguy in enemy.badguys:
            for miss in fighter.missiles:
                if badguy.hit_by(miss):
