...
def main():
    ...
    while True:
        ...
        if pressed_keys[pygame.K_RIGHT] and event.type == pygame.KEYDOWN:
            cloud.x = cloud.x + 5
        # the KEYDOWN event.type instrcution after the and is a precaution to make sure that an extra event doesn't occur when the user lets off the key they are using
        ...
        # Done: Inside the game loop, make the Cloud "rain", and then:
