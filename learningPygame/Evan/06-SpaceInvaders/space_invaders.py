...
class Missile:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (0, 255, 100), (self.x, self.y), (self.x, self.y-8), 4)
...
class Scoreboard:
    ...
    def draw(self):
        text_as_image = self.font.render('Score' + str(self.score) , True, (255, 255 , 0))
...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN and pressed_keys[pygame.K_SPACE]:
                fighter.fire()
            if event.type == QUIT:
                sys.exit()
